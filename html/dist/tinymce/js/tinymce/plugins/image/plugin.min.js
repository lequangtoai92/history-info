...
tinymce.PluginManager.add('image', function (editor) {
    ...
    function showDialogCustom() {
        ...
        $('.dz-message').show();
        $('.div-body-get-url').empty();
        $('.pro-bar').hide();
        $('.div-progress-bar').hide();
        $('.div-upload-from-avai > .div-image').removeClass('active');
        $('#div-img-inputhidden').empty();
        $('.div-body-get-url').empty();
        $('.li-header-nav').removeClass('acive');
        $('.li-upload').click();
        $('.click-show-upload-img').click();
    }
    ...
    editor.addButton('image', {
        ...
        onclick: createImageList(showDialogCustom),
    ...
    editor.addCommand('mceImage', createImageList(showDialogCustom));
});
